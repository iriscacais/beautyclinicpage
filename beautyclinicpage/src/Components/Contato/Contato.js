        ...
        return (
            <section className="sectionContato col-lg-12" id="contato">
                ...
                <div className="divContato">
                    ...
                    <p className="invite">Ficou interessado em nossos serviços?<br></br> Venha nos conhecer!</p>
                    ...
                    <p>
                        <a href="https://www.whatsapp.com/?lang=pt_BR" target="_blank" rel="noopener noreferrer imageLinks"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-whatsapp" viewBox="0 0 16 16">
